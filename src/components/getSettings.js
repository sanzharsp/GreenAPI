...
const SettingsGet = () => { 
    ...
    const onFinish = (values) => {
        ...
        // You can call the appropriate function based on the clicked button
 
            axios
            .get(`https://api.green-api.com/waInstance${values.idInstance}/getSettings/${values.ApiTokenInstance}`)
            .then((response) => {
  ...
  >
    ...
    >
      ...
      <Button type="primary" htmlType="submit" name="button" value="getSettings">
        getSettings
      </Button>
